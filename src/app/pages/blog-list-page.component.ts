...
@Component({
  ...
  .eyebrow{color: #ff9700; font-size: .92rem; letter-spacing: .1em; line-height: 1.25;}
    .search { max-width: 320px; min-height: 46px; }
    .filter-row { align-items: center; display: flex; flex-wrap: wrap; gap: .7rem; justify-content: space-between; margin-bottom: 1.4rem; }
