...
export class PolicyPageComponent {
  ...
  readonly sections = this.page === 'privacy'
    ...
    : [
        ...
        { heading: '24. Privacy', paragraphs: ['Our collection and use of your personal data is governed by our Privacy Policy, which forms part of this Agreement.'] },
        {
        ...
        { heading: '28. Governing Law', paragraphs: ['This Agreement is governed by the laws of India. Subject to Section 29, the courts at Pune, India shall have exclusive jurisdiction.'] },
        {
