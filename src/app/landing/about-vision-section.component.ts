...
@Component({
  ...
  `,
  styles: [`
    .why-us-section { display: grid; gap: clamp(1.5rem, 4vw, 3rem); grid-template-columns: 1fr; padding: clamp(2rem, 6vw, 4.8rem); }
    .why-heading { max-width: 920px; }
    h2 { color: #111; font-size: clamp(2.15rem, 4vw, 3.75rem); font-weight: 900; letter-spacing: 0; line-height: 1.08; margin: 0 0 1.2rem; max-width: 900px; word-spacing: 0; }
    .why-heading p:not(.eyebrow) { color: #242424; font-size: 1.05rem; line-height: 1.7; margin: 0; max-width: 760px; }
    .why-grid { display: grid; gap: 1rem; grid-template-columns: repeat(4, minmax(0, 1fr)); }
