...
export const routes: Routes = [
  ...
  { path: 'admin/inventory/new', component: AdminProductCreatePageComponent, canActivate: [() => requireAnyRole(['SUPER_ADMIN', 'ADMIN', 'MANAGER', 'INVENTORY_STAFF'], '/admin/inventory/new')], title: 'Add Product | Clickkaar' },
  { path: 'admin/inventory/edit/:id', component: AdminProductCreatePageComponent, canActivate: [() => requireAnyRole(['SUPER_ADMIN', 'ADMIN', 'MANAGER', 'INVENTORY_STAFF'], '/admin/inventory/edit')], title: 'Edit Product | Clickkaar' },
