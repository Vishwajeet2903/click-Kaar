...
@Component({
  ...
  .brand { align-items: center; display: inline-flex; flex: 0 0 auto; gap: .85rem; min-width: 0; }
    ...
    footer { align-items: center; background: #242424; display: flex; justify-content: center; padding: 1.25rem 0; }
    ...
    .brand-block { display: grid; gap: 1.15rem; }
    ...
    nav a { color: #eeeeee; display: block; font-size: .98rem; font-weight: 500; line-height: 1.45; margin: .72rem 0; }
    nav a:hover { color: #ff9700; }
    .contact-card p { color: #c9c9c9; line-height: 1.55; margin: 0 0 1rem; }
    .footer-bottom { align-items: center; border-top: 1px solid rgba(255,255,255,.1); color: #eeeeee; display: flex; font-size: .9rem; font-weight: 500; justify-content: space-between; line-height: 1.5; margin-top: 1.4rem; padding-top: 1.2rem; }
