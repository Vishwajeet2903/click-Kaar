...
@Component({
  ...
  styles: [`
    ...
    .cart-link b { align-items: center; background: #ff9700; border: 2px solid #fff; border-radius: 999px; color: #fff; display: inline-flex; font-size: .66rem; font-weight: 950; height: 18px; justify-content: center; line-height: 1; min-width: 18px; padding: 0 .24rem; position: absolute; right: -4px; top: -5px; }
    .cart-link:hover { background: #ff9700; color: #fff; transform: translateY(-1px); }
    .cart-link:hover b { background: #fff; border-color: #ff9700; color: #111; }
