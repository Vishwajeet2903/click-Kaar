...
```powershell
cd backend
gcloud builds submit --config cloudbuild.yaml --substitutions _REGION=$REGION,_REPOSITORY=$REPOSITORY,_SERVICE=$SERVICE,_CORS_ALLOWED_ORIGINS=https://click-kaar.com,https://www.click-kaar.com,https://clickkaar.com,https://www.clickkaar.com,https://click-kaar.web.app,https://click-kaar.firebaseapp.com,http://localhost:4200,http://127.0.0.1:4200,_FRONTEND_LOGIN_URL=https://click-kaar.com/login
```
